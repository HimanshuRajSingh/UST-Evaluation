package com.him.Email_Simulation.controller;
...
public class MyControllerMail {
	@Autowired
	com.him.Email_Simulation.service.MyService ms;
	@Autowired
	HttpSession hp;
	...
	public ModelAndView logout(@ModelAttribute User_Info use,HttpServletRequest req,HttpServletResponse res,HttpSession session) {
...
/*		System.out.println("inside controller");
		...
		if(b){
			return new ModelAndView("registration","msg","registration succesfull");
		}else{
			return new ModelAndView("registration","msg","Email Already exist");
		}
	...
	/*@RequestMapping(value="/composeRe",method=RequestMethod.POST)
	public ModelAndView reCompose(@RequestParam int id,HttpServletRequest req)
	{
		System.out.println("inside controller");
		boolean b=ms.reCompose(id, req);
		if(b)
		{
			return new ModelAndView("menu","msg","Resend success and saved to sent");
		}
		else{
			return new ModelAndView("menu","msg","Message Saved to Draft");
		}
	}*/
